...
const items = ["Matheus", true, 2, 4.12, []]
...
for (let i = 0; i < users.length; i++){
    console.log(`Imprimindo usuario n° ${i}: ${users[i]}`)
}

users.forEach((user, index) => {
    console.log(`Imprimindo usuario n° ${index} : ${user} com forEach`)
})
...
console.log(somaInfinita(10, 14, 213, 3289))
...
console.log(somaInfinita2(10, 1239, 192617, 238741, 12736))
...
// 28 - obj para Json e Json para obj
