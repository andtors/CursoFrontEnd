    ...
    <div className="memory-page">
      ...
      <div className="comment-form">
        ...
        <form onSubmit={handleSubmit}>
          <label><input type="text" placeholder="Seu nome" onChange={(e) => setName(e.target.value)}/></label>
          <label><textarea placeholder="Seu comentário" onChange={(e) => setText(e.target.value)}></textarea></label>
          <input type="submit" value={"Enviar"} className="btn"/>
        </form>
      </div>
      <div className="comments-container">
        <h3>Comentarios ({comments.length})</h3>
        {comments.length === 0 && <p>Não há comentário...</p>}
        {comments.length > 0 && (
