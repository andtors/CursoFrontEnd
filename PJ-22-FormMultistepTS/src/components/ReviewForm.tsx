  ...
  return (
    <div className="review-form">
      ...
      <div className="form-control">
          ...
          <textarea name="comment" id="comment" placeholder="Conte como foi a sua experiencia com o produto..." value={data.comment || ""} onChange={(e) => updateFieldHandler("comment", e.target.value)} required></textarea>
        </div>
    </div>
  )
}
