...
const {createMemory, getAll, get, remove, updateMemory, toggleFavorites, addComent} = require("./controllers/MemoryController")
...
router.patch("/:id/favorite", (req, res) => toggleFavorites(req, res))
